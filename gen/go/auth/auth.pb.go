...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\x05email\x18\x02 \x01(\tR\x05email2\xe0\x02\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponse\x125\n" +
	"\n" +
	"LoginAdmin\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x12>\n" +
	"\rRegisterAdmin\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x12<\n" +
	"\vGetInfoUser\x12\x15.auth.UserInfoRequest\x1a\x16.auth.UserInfoResponseB\x1bZ\x19barcek2281.auth.v1;authv1b\x06proto3"
...
var file_auth_auth_proto_depIdxs = []int32{
	...
	2, // 3: auth.Auth.LoginAdmin:input_type -> auth.LoginRequest
	0, // 4: auth.Auth.RegisterAdmin:input_type -> auth.RegisterRequest
	6, // 5: auth.Auth.GetInfoUser:input_type -> auth.UserInfoRequest
	...
	3, // 9: auth.Auth.LoginAdmin:output_type -> auth.LoginResponse
	1, // 10: auth.Auth.RegisterAdmin:output_type -> auth.RegisterResponse
	7, // 11: auth.Auth.GetInfoUser:output_type -> auth.UserInfoResponse
